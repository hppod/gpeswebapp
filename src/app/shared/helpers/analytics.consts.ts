...
export const __event_noticia: string = "navigate_to_noticia_"
export const __event_login: string = "navigate_to_login"
export const __event_processoSeletivo: string = "navigate_to_processoSeletivo"

//Categories
export const __category_institucional: string = "Institucional"
...
export const __action_noticia: string = "Notícia "
export const __action_login: string = "Login"
export const __action_processoSeletivo: string = "Processo Seletivo"