...
export class PublicacoesService {
    ...
    getDocumentsWithParams(modifier: string): Observable<HttpResponse<Publicacoes[]>> {
        return this.http.get<Publicacoes[]>(`${GPESWebApi}/${modifier}/transparencia/listar-todos`, { params: this.params, observe: 'response' })
    }
