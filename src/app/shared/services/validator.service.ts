...
export class ValidatorService {
    ...
    checkUniqueSobreTitulo(titulo: string) {
        ...
        return this.http.get<any>(`${AsiloWebApi}/authenticated/validators/unique/sobre/titulo`, { params: params })
    }
    ...
    checkUniqueFAQPergunta(pergunta: string) {
        ...
        return this.http.get<any>(`${AsiloWebApi}/authenticated/validators/unique/faq/pergunta`, { params: params })
    }
    ...
    checkUniqueContatoNome(nome: string) {
        ...
        return this.http.get<any>(`${AsiloWebApi}/authenticated/validators/unique/contato/nome`, { params: params })
    }

    /**Função que realiza a requisição do tipo POST ao endpoint “/authenticated/validators/unique/transparencia/titulo”. A requisição possui um parâmetro obrigatório (title). */
    checkUniqueTransparenciaTitulo(titulo: string) {
        let params = new HttpParams()
        params = params.append('title', titulo)
        return this.http.get<any>(`${AsiloWebApi}/authenticated/validators/unique/transparencia/titulo`, { params: params })
    }
    ...
    checkUniqueCategoriaNome(name: string) {
        ...
        return this.http.get<any>(`${AsiloWebApi}/authenticated/validators/unique/categoria/nome`, { params: params })
    }
    ...
    checkUniqueUsuarioNome(nome: string) {
        let params = new HttpParams()
        params = params.append('name', nome)
        return this.http.get<any>(`${AsiloWebApi}/authenticated/validators/unique/usuario/nome`, { params: params })
    }
    ...
    checkUniqueUsuarioUsuario(usuario: string) {
        ...
        return this.http.get<any>(`${AsiloWebApi}/authenticated/validators/unique/usuario/usuario`, { params: params })
    }
    ...
    checkUniqueUsuarioEmail(email: string) {
        ...
        return this.http.get<any>(`${AsiloWebApi}/authenticated/validators/unique/usuario/email`, { params: params })
    }
}